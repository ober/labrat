...
Dir.glob("#{ENV['HOME']}/out/*vmstat.json") do |json|
  ...
  if data['status']['value'] == "OK"
    ...
    queue.add  "vmstat_K_active_memory" => { :type => :counter, :value => data['data']['K_active_memory'], :source => name }
    queue.add  "vmstat_K_buffer_memory" => { :type => :counter, :value => data['data']['K_buffer_memory'], :source => name }
    queue.add  "vmstat_K_free_memory" => { :type => :counter, :value => data['data']['K_free_memory'], :source => name }
    queue.add  "vmstat_K_free_swap" => { :type => :counter, :value => data['data']['K_free_swap'], :source => name }
    queue.add  "vmstat_K_inactive_memory" => { :type => :counter, :value => data['data']['K_inactive_memory'], :source => name }
    queue.add  "vmstat_K_swap_cache" => { :type => :counter, :value => data['data']['K_swap_cache'], :source => name }
    queue.add  "vmstat_K_total_memory" => { :type => :counter, :value => data['data']['K_total_memory'], :source => name }
    queue.add  "vmstat_K_total_swap" => { :type => :counter, :value => data['data']['K_total_swap'], :source => name }
    queue.add  "vmstat_K_used_memory" => { :type => :counter, :value => data['data']['K_used_memory'], :source => name }
    queue.add  "vmstat_K_used_swap" => { :type => :counter, :value => data['data']['K_used_swap'], :source => name }
    queue.add  "vmstat_boot_time" => { :type => :counter, :value => data['data']['boot_time'], :source => name }
